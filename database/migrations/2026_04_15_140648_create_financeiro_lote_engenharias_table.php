...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('financeiro_lote_engenharias')) {
            return;
        }

        Schema::create('financeiro_lote_engenharias', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('financeiro_lote_engenharias');
    }
};
