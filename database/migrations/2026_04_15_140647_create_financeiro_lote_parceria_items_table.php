...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('financeiro_lote_parceria_items')) {
            return;
        }

        Schema::create('financeiro_lote_parceria_items', function (Blueprint $table) {
            $table->id();
            $table->foreignId('lote_id')
                ->constrained('financeiro_lote_parcerias')
                ->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('financeiro_lote_parceria_items');
    }
};
