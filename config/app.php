...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Fuso horário exibido e usado por Carbon/now() em toda a aplicação.
    | Padrão: Brasília (Brasil). Sobrescreva com APP_TIMEZONE no .env se precisar.
    |
    */
